...
describe('Page: PublicHomePage', () => {
  ...
  it('should show message if no assessments found',
    async(() => {
  ...
  // it('should show available assessment list',
  //   fakeAsync(() => {
  //     fixture.whenStable().then(() => {
  //       fixture.detectChanges();
  //       console.warn(componentInstance.filteredAssessments);
  //       expect(componentInstance.filteredAssessments.length).toBeGreaterThan(0);
  //     });
  //   })
  // );

  // it('should redirect to options page',
  //   async(() => {
  //     spyOn(componentInstance.navController, 'push').and.returnValue(mockNavController)
  ...
  //     componentInstance.onAssessment(assessmentId);
  //     fixture.detectChanges();
  //     expect(componentInstance.navController.push).toHaveBeenCalledWith(OptionsPage, { assessmentId: assessmentId });
  //   })
  // );
